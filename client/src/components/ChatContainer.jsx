       ...
       <div className='text-center text-xs'>
        <img 
           src={
            ...
            ? authUser?.profilePic || assets.avatar_icon  // default white avatar
  ...
  {/* {-------bottom area--------} */}
     <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
      <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
        ...
        onKeyDown={(e)=>e.key === "Enyer" ? handleSendMessage(e):null}
       ...
       src={assets.send_button} className='w-7 cursor-pointer' alt="" />
